    ...
    <article className="w-72 p-2 bg-gradient-to-br from-purple-900 via-purple-700 to-purple-600 bg-[length:200%_200%] rounded-lg hover:animate-gradient">
      <div className="relative h-full overflow-hidden text-sm rounded-md bg-white">
        ...
        <div className="p-5 text-sm text-black">
          ...
          <Link to={`/post/${post.slug}`}>
            <button className="w-full mt-4 bg-gradient-to-br from-purple-900 via-purple-700 to-purple-600 bg-[length:200%_200%] text-white text-sm font-bold rounded-md py-2 transition-transform transform active:translate-y-1 hover:animate-gradient">
              Ir a la publicación
            </button>
          </Link>
        </div>
